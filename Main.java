package com.global.BillApplication1;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		String output1=String.format("%51s", "Bill Amount:"+billAmount);
		System.out.println(output1);
		String output2=String.format("%54s", "Add: Sales Tax:"+tax);
		System.out.println(output2);
		String output3=String.format("%53s", "Final Amount:"+total);
